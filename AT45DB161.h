...
// #define ATMEL_WRITE_PROTECT 
#define ATMEL_CS LATBbits.LATB4
#define ATMEL_SPI_CHANNEL 1

#define PROGRAMMING_TIMEOUT 10 // 10 milliseconds
#define SECTOR_ERASE_TIMEOUT 4000 // 4 seconds
#define PAGE_ERASE_TIMEOUT 70 // 70 millisecnds
#define CHIP_ERADE_TIMEOUT 60000 // 60 seconds
#define DEFAULT_ATMEL_TIMEOUT 10 // 10 millisecnds

#define WRITE_PROTECT_OFF() SPARE2_Set()
#define WRITE_PROTECT_ON() SPARE2_Clear()
